...
import { handleWelcome } from "../plugins/قائمة1/الترحيب.js";
...
export async function handleMessages(sock, { messages }) {
    ...
    if (!sock._welcomeListenerAttached) {
        ...
        console.log('✅ مستمع الترحيب تم تفعيله');
    }
}
...
async function handleSingleMessage(sock, msg) {
    ...
    // تأكد من أن isGroup صحيح
    const isGroup = chatId.endsWith('@g.us');
    console.log(`🔍 chatId: ${chatId}, isGroup: ${isGroup}`);
...
ELITE  : ${eliteStatus}`;
    ...
    // التحقق من مكان الأمر (مجموعة أو خاص)
